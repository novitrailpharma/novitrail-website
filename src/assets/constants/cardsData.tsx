...
export const featuresData = {
	...
	cards: [
		{
			title: "GDP Compliant",
			icon: <Award size={36} className="text-novitrail-orange"/>,
		...
		},
		{
			...
			icon: <Brain size={36} className="text-novitrail-blue"/>,
		...
		},
		{
			...
			icon: <ShieldCheck size={36} className="text-novitrail-orange"/>,
...
export const servicesData = {
	...
	cards: [
		{
			icon: <Truck size={36} className="text-novitrail-orange"/>,
		...
		{
			icon: <Pill size={36} className="text-novitrail-orange"/>,
...
export const missionData = {
	...
	cards: [
		{
			icon: <Target size={36} className="text-novitrail-orange" />,
		...
		{
			icon: <BarChart4 size={36} className="text-novitrail-blue" />,
		...
		{
			icon: <Globe2 size={36} className="text-novitrail-orange" />,
...
export const navCardsData = {
	...
	cards: [
		...
		{
			icon: <Pill size={36} className="text-novitrail-blue"/>,
		...
		{
			icon: <Syringe size={36} className="text-novitrail-orange"/>,
